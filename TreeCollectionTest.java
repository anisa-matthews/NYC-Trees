...
//					tl  instanceof ArrayList<?> ) ;
	...
	public void testGetCountByTreeSpeciesBorough2() {
		...
		tl.add(t1);
		tl.add(t2);
		System.out.println(tl.getCountByTreeSpeciesBorough("oak", "Manhattan"));
		assertTrue("return value for \"oak\", \"Manhattan\" not equal to 2 after adding t1(Oak, Manhattan) and t2(Red Oak, Manhattan)",
				tl.getCountByTreeSpeciesBorough("oak", "Manhattan") == 2 );
		tl.add(t4);
		tl.add(t8);
		System.out.println(tl.getCountByTreeSpeciesBorough("oak", "Manhattan"));
		assertTrue("return value for\"oak\", \"Manhattan\"  not equal to 2  after adding t1(Oak, Manhattan) and t2(Red Oak, Manhattan), t4 (Oaktree, Brooklyn) and t8(Birch Oak, Bronx)",
				tl.getCountByTreeSpeciesBorough("oak", "Manhattan")== 2 );
	}
